...
export const Projects = () => {
  ...
  return(
    <section data-aos="fade-down" data-aos-duration="1500" className="portfolio__section" id="portfolio">
      <h2 className="section-portfolio__title">Proyectos</h2>
      <p className="text-content">Desplaza para ver algunos de los proyectos personales en los que trabajo... </p>
